...
class MatchHistoryService:
    ...
    def _get_matches_filtered_by_name(search_query: str, page: int, matches_on_page_cnt: int):
        return MatchDAO.fetch_filtered(search_query, page, matches_on_page_cnt)

    def get_matches(search_name: str, page: int, matches_on_page_cnt: int)  -> Tuple[int, int, List[ReadMatchDTO]]:
        """
